...
/// A stateless widget that represents the Gas Outlet Page.
/// 
/// This page displays various sensor data related to the gas outlet, such as temperature,
/// pressure, oxygen, carbon dioxide, and humidity levels. It also provides navigation,
/// status, and notification management.
class GasOutletPage extends StatelessWidget {
  const GasOutletPage({Key? key}) : super(key: key);
                ...
                children: [
                  ...
                  Consumer<DataManager>(
                    builder: (context, manager, _) {
                      ...
                      final temp5 =
                          double.tryParse(manager.getLatestValue('pbr1_temp_g_2')) ??
                              0.0;
                      final temp4 =
                          double.tryParse(manager.getLatestValue('pbr1_amb_press_2')) ??
                              0.0;
                      final temp3 =
                          double.tryParse(manager.getLatestValue('pbr1_o2_2')) ??
                              0.0;
                      final temp2 =
                          double.tryParse(manager.getLatestValue('pbr1_co2_2')) ??
                              0.0;

                      final temp1 = double.tryParse(
                              manager.getLatestValue('pbr1_rh_2')) ??
                          0.0;
                      ...
                      return Column(
                        ...
                        children: [
                          _buildField(
                            'Temperature',
                            formatValue(temp5),
                            determineColor('Temperature (Output, g)', temp5),
                          ),
                          _buildField(
                            'Air Pressure',
                            formatValue(temp4),
                            determineColor('Air Pressure (Output, g)', temp4),
                          ),
                          _buildField(
                            'O2 Conct',
                            formatValue(temp3),
                            determineColor('O2 Concentration (Output, g)', temp3),
                          ),
                          _buildField(
                            'CO2 Conct',
                            formatValue(temp2),
                            determineColor('CO2 Concentration (Output, g)', temp2),
                          ),
                          _buildField(
                            'Humidity',
                            formatValue(temp1),
                            determineColor('Humidity (Output, g)', temp1),
                          ),
                        ],
                      );
                    },
  ...
  child: Consumer<DataManager>(
    builder: (context, dataManager, _) {
      final sensors = ["Air Pressure", "Carbon Dioxide", "Oxygen Concentration", "Humidity", "Gas Temperature"];
      final sensorKeys = ['pbr1_amb_press_2', 'pbr1_co2_2', 'pbr1_o2_2', 'pbr1_rh_2', 'pbr1_temp_g_2'];
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                // Hinzufügen des Last Updated Feldes
                const SizedBox(height: 8),
                Column(
                  crossAxisAlignment: CrossAxisAlignment.stretch,
                  children: [
