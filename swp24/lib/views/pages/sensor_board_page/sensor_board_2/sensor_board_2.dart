...
/// A stateless eidget that represents the Sensor Board 2.
/// 
/// This page displays the various measurements for the sensor board 2, including 4 temperature measures, the average temperature for that board, and one air pressure measurement.
/// It also includes navigation, status, and notifications management.
class SensorBoard2 extends StatelessWidget {
  const SensorBoard2({Key? key}) : super(key: key);
                    ...
                    children: [
                      ...
                      Consumer<DataManager>(
                        builder: (context, manager, _) {
                          ...
                          final temp1 =
                              double.tryParse(manager.getLatestValue('board2_temp1_am')) ??
                                  0.0;
                          final temp2 =
                              double.tryParse(manager.getLatestValue('board2_temp2_am')) ??
                                  0.0;
                          final temp3 =
                              double.tryParse(manager.getLatestValue('board2_temp3_am')) ??
                                  0.0;
                          final temp4 =
                              double.tryParse(manager.getLatestValue('board2_temp4_am')) ??
                                  0.0;
                          ...
                          final airPressure = double.tryParse(
                                  manager.getLatestValue('board2_amb_press')) ??
                              0.0;
