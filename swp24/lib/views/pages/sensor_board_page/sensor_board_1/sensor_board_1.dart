...
/// A stateless eidget that represents the Sensor Board 1.
/// 
/// This page displays the various measurements for the sensor board 1, including 4 temperature measures, the average temperature for that board, and one air pressure measurement.
/// It also includes navigation, status, and notifications management.
class SensorBoard1 extends StatelessWidget {
  const SensorBoard1({Key? key}) : super(key: key);
                    ...
                    children: [
                      ...
                      Consumer<DataManager>(
                        builder: (context, manager, _) {
                          ...
                          final temp1 =
                              double.tryParse(manager.getLatestValue('board1_temp1_am')) ??
                                  0.0;
                          final temp2 =
                              double.tryParse(manager.getLatestValue('board1_temp2_am')) ??
                                  0.0;
                          final temp3 =
                              double.tryParse(manager.getLatestValue('board1_temp3_am')) ??
                                  0.0;
                          final temp4 =
                              double.tryParse(manager.getLatestValue('board1_temp4_am')) ??
                                  0.0;
                          ...
                          final airPressure = double.tryParse(
                                  manager.getLatestValue('board1_amb_press')) ??
                              0.0;
